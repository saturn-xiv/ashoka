...
inline bool TtsRequest_Locale_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TtsRequest_Locale* value) {
...
inline bool AudioRequest_Type_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, AudioRequest_Type* value) {
...
inline bool VideoRequest_Type_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, VideoRequest_Type* value) {
...
class TtsRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static inline bool Locale_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      Locale* value) {
