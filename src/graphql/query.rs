...
use super::{context::Context, Pager, I64};
...
impl Query {
    ...
    fn indexUserPolicies(
        ...
        let items = nut::graphql::users::Policy::index(context, id.0)?;
        Ok(items)
    }
    ...
    fn showCard(context: &Context, id: I64) -> FieldResult<nut::graphql::cards::Card> {
    ...
    fn showCategory(context: &Context, id: I64) -> FieldResult<nut::graphql::categories::Category> {
