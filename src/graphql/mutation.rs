...
use super::{context::Context, I64, OK};
...
impl Mutation {
    ...
    fn lockUser(context: &Context, id: I64) -> FieldResult<OK> {
    ...
    fn destoryLocale(context: &Context, id: I64) -> FieldResult<OK> {
        nut::graphql::locales::Destory::execute(context, id)?;
        Ok(OK::default())
    }

    #[graphql(description = "Destory attachment")]
    fn destoryAttachment(context: &Context, id: I64) -> FieldResult<OK> {
    ...
    fn updateCard(context: &Context, id: I64, form: nut::graphql::cards::Form) -> FieldResult<OK> {
        form.update(context, id)?;
        Ok(OK::default())
    }
    #[graphql(description = "Destory card")]
    fn destoryCard(context: &Context, id: I64) -> FieldResult<OK> {
    ...
    fn destoryCategory(context: &Context, id: I64) -> FieldResult<OK> {
