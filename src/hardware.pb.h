...
inline void Audio_Stream::set_payload(const void* value, size_t size) {
...
inline void Audio_File::set_path(const char* value, size_t size) {
...
inline void Video_Stream::set_payload(const void* value, size_t size) {
...
inline void Video_File::set_path(const char* value, size_t size) {
